        ...
        @else
          ...
          <div id="dropdownAvatarName" class="z-20 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownInformdropdownAvatarNameButtonationButton">
              <li>
                <a href="{{ route('auth.login') }}"
                  class="block px-4 py-2 text-sm text-gray-700 hover:bg-movieapp-600 hover:text-white">Sign In</a>
              </li>
            </ul>

            <div class="py-2">
              <a href="{{ route('auth.register') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-400">
                Register</a>
            </div>
          </div>
        @endauth
