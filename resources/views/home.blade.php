  ...
  <div class="w-full h-auto min-h-screen flex flex-col">
    ...
    <div class="w-full h-[512px] flex flex-col relative bg-black">
      ...
      <div class="flex flex-row items-center w-full h-full relative slide">
        {{-- Image --}}
        <img src="https://via.placeholder.com/960x512" alt="" class="absolute w-full h-full object-cover">
        ...
        <div class="w-10/12 flex flex-col col ml-28 z-10 ">
          ...
          <span class="font-inter text-xl text-white w-1/2 line-clamp-2">Lorem ipsum dolor, sit amet consectetur
            adipisicing elit. Culpa, voluptatibus optio dolorum ratione est iure consectetur rerum quam in modi quasi
            esse delectus atque aperiam vero velit obcaecati mollitia deserunt?</span>
          <a href="/movie/id"
      ...
      <div class="absolute bottom-0 w-full mb-8">
        <div class="w-full flex flex-row items-center justify-center">
          ...
          <div class="w-2.5 h-2.5 rounded-full mx-1 cursor-pointer bg-white dot"></div>
          <div class="w-2.5 h-2.5 rounded-full mx-1 cursor-pointer bg-white dot"></div>
          <div class="w-2.5 h-2.5 rounded-full mx-1 cursor-pointer bg-movieapp-500 dot"></div>
          <div class="w-2.5 h-2.5 rounded-full mx-1 cursor-pointer bg-white dot"></div>
        </div>
      </div>
    </div>
