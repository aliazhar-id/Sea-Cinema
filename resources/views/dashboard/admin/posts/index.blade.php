        ...
        <tbody>
          @foreach ($posts as $post)
            <tr>
              ...
              <td>{{ $post->title }}</td>
              <td>{{ $post->author->username ?? "DeletedAuthor-$post->id_user" }}</td>
              <td>{{ $post->category->name }}</td>
              <td>{{ $post->created_at->diffForHumans() }}</td>
              <td>{{ $post->click }}</td>
              <td>
                <a href="{{ route('admin.posts.show', $post->slug) }}" class="badge bg-primary"><span
                    data-feather="eye"></span>
                </a>
                <a href="{{ route('admin.posts.edit', $post->slug) }}" class="badge bg-warning"><span
