  ...
  <div class="h-screen md:flex">
    ...
    <div class="flex md:w-1/2 justify-center py-10 mx-5 items-center bg-white">
      <form class="bg-white w-full md:max-w-screen-sm" action="{{ route('auth.actionRegister') }}" method="POST">
        ...
        <div class="flex md:flex-row gap-4 md:gap-0 flex-col mb-4">
          ...
          <div class="flex flex-col w-full md:w-1/2 md:mr-1">
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl @error('username') border-red-500 @enderror">
              ...
              <input class="pl-2 outline-none border-none w-full" type="text" name="username" placeholder="Username" />
            </div>
          ...
          <div class="flex flex-col w-full md:w-1/2 md:ml-1">
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl @error('name') border-red-500 @enderror">
              ...
              <input class="pl-2 outline-none border-none w-full" type="text" name="name" placeholder="Full name" />
            </div>
        ...
        <button type="submit"
          class="block hover:brightness-75 duration-300 w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">
          Login
        </button>
      </form>
    </div>
