        ...
        <div class="flex md:flex-row gap-4 md:gap-0 flex-col mb-4">
          ...
          <div class="flex flex-col w-full md:w-1/2 md:mr-1">
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
              ...
              <input class="pl-2 outline-none border-none" type="text" name="username" placeholder="Username" />
            </div>
          ...
          <div class="flex flex-col w-full md:w-1/2 md:ml-1">
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
              ...
              <input class="pl-2 outline-none border-none" type="text" name="name" placeholder="Full name" />
            </div>
