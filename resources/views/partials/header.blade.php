<div class="w-full bg-white h-[96px] drop-shadow-lg flex row items-center" 96px="">
  <div class="w-1/3 pl-5">
    ...
    <a href="/tv-shows" class="uppercase text-base mx-5 text-black hover:text-movieapp-500 duration-200 font-inter">
      TV Shows
    </a>
  </div>
  ...
  <div class="w-1/3 flex flex-row justify-end pr-10">
    <a href="/search" class="group">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30px" height="30px">
        <path class="fill-black group-hover:fill-movieapp-500 duration-200"
